...
var _HDNodeWallet_instances, _a, _HDNodeWallet_account, _HDNodeWallet_fromSeed;
...
class HDNodeWallet extends base_wallet_js_1.BaseWallet {
    ...
    constructor(guard, signingKey, parentFingerprint, chainCode, path, index, depth, mnemonic, provider) {
        ...
        _HDNodeWallet_instances.add(this);
    ...
    encrypt(password, progressCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, json_keystore_js_1.encryptKeystoreJson)(__classPrivateFieldGet(this, _HDNodeWallet_instances, "m", _HDNodeWallet_account).call(this), password, { progressCallback });
        });
    }
    /**
    ...
    encryptSync(password) {
        return (0, json_keystore_js_1.encryptKeystoreJsonSync)(__classPrivateFieldGet(this, _HDNodeWallet_instances, "m", _HDNodeWallet_account).call(this), password);
    }
    /**
     *  The extended key.
     *
...
_a = HDNodeWallet, _HDNodeWallet_instances = new WeakSet(), _HDNodeWallet_account = function _HDNodeWallet_account() {
    ...
    return account;
}, _HDNodeWallet_fromSeed = function _HDNodeWallet_fromSeed(_seed, mnemonic) {
