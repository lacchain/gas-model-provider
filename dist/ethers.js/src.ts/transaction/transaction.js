...
var _Transaction_type, _Transaction_to, _Transaction_data, _Transaction_nonce, _Transaction_gasLimit, _Transaction_gasPrice, _Transaction_maxPriorityFeePerGas, _Transaction_maxFeePerGas, _Transaction_value, _Transaction_chainId, _Transaction_sig, _Transaction_accessList;
...
class Transaction {
     ...
     *  explicit properties.
     */
    get type() { return __classPrivateFieldGet(this, _Transaction_type, "f"); }
    set type(value) {
        switch (value) {
            case null:
                __classPrivateFieldSet(this, _Transaction_type, null, "f");
                break;
            case 0:
            case "legacy":
                __classPrivateFieldSet(this, _Transaction_type, 0, "f");
                break;
            case 1:
            case "berlin":
            case "eip-2930":
                __classPrivateFieldSet(this, _Transaction_type, 1, "f");
                break;
            case 2:
            case "london":
            case "eip-1559":
                __classPrivateFieldSet(this, _Transaction_type, 2, "f");
                break;
            default:
     ...
     */
    get to() { return __classPrivateFieldGet(this, _Transaction_to, "f"); }
    set to(value) {
        __classPrivateFieldSet(this, _Transaction_to, (value == null) ? null : (0, index_js_1.getAddress)(value), "f");
    }
    /**
     *  The transaction nonce.
     */
    get nonce() { return __classPrivateFieldGet(this, _Transaction_nonce, "f"); }
    set nonce(value) { __classPrivateFieldSet(this, _Transaction_nonce, (0, index_js_3.getNumber)(value, "value"), "f"); }
    /**
     *  The gas limit.
     */
    get gasLimit() { return __classPrivateFieldGet(this, _Transaction_gasLimit, "f"); }
    set gasLimit(value) { __classPrivateFieldSet(this, _Transaction_gasLimit, (0, index_js_3.getBigInt)(value), "f"); }
    /**
     *  The gas price.
     *
     ...
     */
    get gasPrice() {
        const value = __classPrivateFieldGet(this, _Transaction_gasPrice, "f");
    ...
    set gasPrice(value) {
        __classPrivateFieldSet(this, _Transaction_gasPrice, (value == null) ? null : (0, index_js_3.getBigInt)(value, "gasPrice"), "f");
    }
    /**
    ...
    get maxPriorityFeePerGas() {
        const value = __classPrivateFieldGet(this, _Transaction_maxPriorityFeePerGas, "f");
        if (value == null) {
            if (this.type === 2) {
                return BN_0;
            }
    ...
    set maxPriorityFeePerGas(value) {
        __classPrivateFieldSet(this, _Transaction_maxPriorityFeePerGas, (value == null) ? null : (0, index_js_3.getBigInt)(value, "maxPriorityFeePerGas"), "f");
    }
    /**
     ...
     */
    get maxFeePerGas() {
        const value = __classPrivateFieldGet(this, _Transaction_maxFeePerGas, "f");
        if (value == null) {
            if (this.type === 2) {
                return BN_0;
            }
    ...
    set maxFeePerGas(value) {
        __classPrivateFieldSet(this, _Transaction_maxFeePerGas, (value == null) ? null : (0, index_js_3.getBigInt)(value, "maxFeePerGas"), "f");
    }
    /**
     *  The transaction data. For ``init`` transactions this is the
     *  deployment code.
     */
    get data() { return __classPrivateFieldGet(this, _Transaction_data, "f"); }
    set data(value) { __classPrivateFieldSet(this, _Transaction_data, (0, index_js_3.hexlify)(value), "f"); }
    /**
     *  The amount of ether (in wei) to send in this transactions.
     */
    get value() { return __classPrivateFieldGet(this, _Transaction_value, "f"); }
    set value(value) {
        __classPrivateFieldSet(this, _Transaction_value, (0, index_js_3.getBigInt)(value, "value"), "f");
    }
    /**
     *  The chain ID this transaction is valid on.
     */
    get chainId() { return __classPrivateFieldGet(this, _Transaction_chainId, "f"); }
    set chainId(value) { __classPrivateFieldSet(this, _Transaction_chainId, (0, index_js_3.getBigInt)(value), "f"); }
    /**
     *  If signed, the signature for this transaction.
     */
    get signature() { return __classPrivateFieldGet(this, _Transaction_sig, "f") || null; }
    set signature(value) {
        __classPrivateFieldSet(this, _Transaction_sig, (value == null) ? null : index_js_2.Signature.from(value), "f");
    }
    /**
     *  The access list.
     *
     ...
     */
    get accessList() {
        const value = __classPrivateFieldGet(this, _Transaction_accessList, "f") || null;
        if (value == null) {
    ...
    set accessList(value) {
        __classPrivateFieldSet(this, _Transaction_accessList, (value == null) ? null : (0, accesslist_js_1.accessListify)(value), "f");
    }
    /**
    ...
    constructor() {
        ...
        _Transaction_to.set(this, void 0);
        _Transaction_data.set(this, void 0);
        _Transaction_nonce.set(this, void 0);
        _Transaction_gasLimit.set(this, void 0);
        _Transaction_gasPrice.set(this, void 0);
        _Transaction_maxPriorityFeePerGas.set(this, void 0);
        _Transaction_maxFeePerGas.set(this, void 0);
        _Transaction_value.set(this, void 0);
        _Transaction_chainId.set(this, void 0);
        _Transaction_sig.set(this, void 0);
        _Transaction_accessList.set(this, void 0);
        __classPrivateFieldSet(this, _Transaction_type, null, "f");
        __classPrivateFieldSet(this, _Transaction_to, null, "f");
        __classPrivateFieldSet(this, _Transaction_nonce, 0, "f");
        __classPrivateFieldSet(this, _Transaction_gasLimit, BigInt(0), "f");
        __classPrivateFieldSet(this, _Transaction_gasPrice, null, "f");
        __classPrivateFieldSet(this, _Transaction_maxPriorityFeePerGas, null, "f");
        __classPrivateFieldSet(this, _Transaction_maxFeePerGas, null, "f");
        __classPrivateFieldSet(this, _Transaction_data, "0x", "f");
        __classPrivateFieldSet(this, _Transaction_value, BigInt(0), "f");
        __classPrivateFieldSet(this, _Transaction_chainId, BigInt(0), "f");
        __classPrivateFieldSet(this, _Transaction_sig, null, "f");
        __classPrivateFieldSet(this, _Transaction_accessList, null, "f");
    }
    /**
