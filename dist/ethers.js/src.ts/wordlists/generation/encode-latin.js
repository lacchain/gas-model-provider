...
var _BitWriter_data, _BitWriter_bitLength;
...
class BitWriter {
    constructor(width) {
        _BitWriter_data.set(this, void 0);
        _BitWriter_bitLength.set(this, void 0);
        this.width = width;
        __classPrivateFieldSet(this, _BitWriter_data, [], "f");
        __classPrivateFieldSet(this, _BitWriter_bitLength, 0, "f");
    }
    write(value) {
        const maxValue = ((1 << this.width) - 1);
        while (value > maxValue) {
            __classPrivateFieldGet(this, _BitWriter_data, "f").push(0);
            __classPrivateFieldSet(this, _BitWriter_bitLength, __classPrivateFieldGet(this, _BitWriter_bitLength, "f") + this.width, "f");
            value -= maxValue;
        }
        __classPrivateFieldGet(this, _BitWriter_data, "f").push(value);
        __classPrivateFieldSet(this, _BitWriter_bitLength, __classPrivateFieldGet(this, _BitWriter_bitLength, "f") + this.width, "f");
    }
    get length() {
        return 1 + Math.trunc((__classPrivateFieldGet(this, _BitWriter_bitLength, "f") + 5) / 6);
    }
    get data() {
        let result = String(this.width);
        let bits = 0;
        let accum = 0;
        const data = __classPrivateFieldGet(this, _BitWriter_data, "f").slice();
        let bitMod = __classPrivateFieldGet(this, _BitWriter_bitLength, "f") % 6;
...
_BitWriter_data = new WeakMap(), _BitWriter_bitLength = new WeakMap();
;
