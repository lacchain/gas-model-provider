...
var _BlockConnectionSubscriber_provider, _BlockConnectionSubscriber_blockNumber, _BlockConnectionSubscriber_running, _BlockConnectionSubscriber_filterId;
...
class BlockConnectionSubscriber {
    constructor(provider) {
        ...
        _BlockConnectionSubscriber_running.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _BlockConnectionSubscriber_running, false, "f");
        __classPrivateFieldSet(this, _BlockConnectionSubscriber_filterId, null, "f");
    }
    start() {
        if (__classPrivateFieldGet(this, _BlockConnectionSubscriber_running, "f")) {
            return;
        }
        __classPrivateFieldSet(this, _BlockConnectionSubscriber_running, true, "f");
...
_BlockConnectionSubscriber_provider = new WeakMap(), _BlockConnectionSubscriber_blockNumber = new WeakMap(), _BlockConnectionSubscriber_running = new WeakMap(), _BlockConnectionSubscriber_filterId = new WeakMap();
