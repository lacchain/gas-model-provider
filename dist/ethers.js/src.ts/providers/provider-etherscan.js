...
class EtherscanProvider extends abstract_provider_js_1.AbstractProvider {
    ...
    constructor(_network, _apiKey) {
        ...
        super();
        _EtherscanProvider_plugin.set(this, void 0);
        const network = network_js_1.Network.from(_network);
        __classPrivateFieldSet(this, _EtherscanProvider_plugin, network.getPlugin(EtherscanPluginId), "f");
     ...
     */
    getBaseUrl() {
        if (__classPrivateFieldGet(this, _EtherscanProvider_plugin, "f")) {
            return __classPrivateFieldGet(this, _EtherscanProvider_plugin, "f").baseUrl;
        }
    ...
    fetch(module, params, post) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.processFunc = (request, response) => __awaiter(this, void 0, void 0, function* () {
...
_EtherscanProvider_plugin = new WeakMap();
